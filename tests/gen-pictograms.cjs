...
const map={battery:'电池包.svg',ups:'UPS.svg',transformer:'隔离变压器.svg',breaker:'断路器.svg',ems:'EMS.svg',meter:'电表.svg',acdc:'AC_DC.svg',dcac:'DC_AC.svg',pdu:'PDU.svg',pv:'光伏板.svg'};
let out='/* 图片层: 内联矢量电气图标 (源自 ess-agent-main/images/icon, 自包含无需运行时加载) */\nwindow.PIC=(function(){\n"use strict";\nconst D={\n';
...
console.log('pictograms.js bytes:',out.length);
